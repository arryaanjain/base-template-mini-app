...
# CryptoSocial - Web3 Social Trading App

A Web3 social app where users send ETH transactions, add witty comments, and share them on a public feed. Built with Next.js, wagmi, and real transaction data.

## 🎯 App Flow

1. **Connect Wallet** - Users connect MetaMask or Coinbase Wallet
2. **Send Transaction** - Send ETH to another address (use testnet!)  
3. **Add Pun** - Write a witty comment about your transaction
4. **Share** - Post appears on public feed with transaction proof
5. **Social** - Others can like and see your trading humor
